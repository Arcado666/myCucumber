...
public class HttpClientUtil {
	 ...
	 *            参数
	 */
	public static String sendHttpPosts(String httpUrl, Map<String, Object> maps) {
		String parem = convertStringParamter1(maps);
		return sendHttpPost(httpUrl, parem);
	}
	 ...
	 * @return 字符串
	 */
	public static String convertStringParamter1(Map<String, Object> parameterMap) {
		StringBuffer parameterBuffer = new StringBuffer();
		if (parameterMap != null) {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(sendHttpGet("http://www.baidu.com",new HashMap<Object, String>()));
